			<div class="navbar-header">
				...
				<div class="nodejsvn-brand">
					<a href="{relative_path}/">
						<img class="{brand:logo:display} nodejsvn-logo" src="{brand:logo}" />
					</a>
					<!-- IF showSiteTitle -->
					<a href="{relative_path}/">
				...
				<ul id="main-nav" class="nav navbar-nav pull-left">
					...
					<li>
						<a href="{relative_path}/unread" title="[[global:header.unread]]">
							<i id="unread-count" class="mdi-content-inbox" data-content="0" ></i><span class="visible-xs-inline"> [[global:header.unread]]</span>
						</a>
					</li>
					<!-- ENDIF loggedIn -->
                    <!--
					...
					<li>
						<a href="{relative_path}/tags" title="[[global:header.tags]]">
							<i class="mdi-action-loyalty"></i><span class="visible-xs-inline"> [[global:header.tags]]</span>
						</a>
					</li>
					<li>
						<a href="{relative_path}/popular" title="[[global:header.popular]]">
							<i class="mdi-image-assistant-photo"></i><span class="visible-xs-inline"> [[global:header.popular]]</span>
						</a>
					</li>
                    <!--
					<li>
					...
					<li>
						<a href="{relative_path}/groups" title="[[global:header.groups]]">
							<i class="mdi-social-group"></i><span class="visible-xs-inline"> [[global:header.groups]]</span>
						</a>
					</li>
					<!-- IF isAdmin -->
					<li>
						<a href="{relative_path}/admin" title="[[global:header.admin]]" target="_top">
							<i class="mdi-action-settings"></i><span class="visible-xs-inline"> [[global:header.admin]]</span>
						</a>
					</li>
					<!-- ENDIF isAdmin -->
					<!-- IF searchEnabled -->
				...
				<ul id="logged-in-menu" class="nav navbar-nav navbar-right pull-right">
					...
					<li class="visible-xs">
						<a href="{relative_path}/notifications" title="[[notifications:title]]">
							<i class="notification-icon mdi-social-notifications-none" data-content="0"></i> [[notifications:title]]
						</a>
					</li>
					...
					<li class="chats dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#" title="[[global:header.chats]]" id="chat_dropdown">
							<i id="chat-count" class="mdi-communication-forum"></i> <span class="visible-xs-inline">[[global:header.chats]]</span>
						</a>
